  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      /* Justificação inteligente: justify + hifenização + interword + word-spacing
         conservador. Última linha à esquerda para evitar "spaced out". */
      .doc p, .doc li {
        text-align: justify;
      ...
      .doc blockquote { max-width: var(--prose-max); }
      .doc blockquote p { max-width: 100%; }
      ...
      .mermaid { font-family: var(--font-body) !important; position: relative; z-index: 1; }
      .mermaid svg { max-width: 100%; height: auto !important; }

      /* Animação só com opacity (não quebra geometria) */
      ...
      .mermaid-wrap.is-visible .mermaid g.cluster,
      .mermaid-wrap.is-visible .mermaid g.actor,
      .mermaid-wrap.is-visible .mermaid g.label,
      .mermaid-wrap.is-visible .mermaid g.statediagram-state { animation: fadeIn 0.6s ease forwards; }
      .mermaid-wrap.is-visible .mermaid .edgeLabel { animation: fadeIn 0.5s ease 0.7s forwards; }
      ...
      .mermaid-wrap .mermaid g.node:hover path {
        filter: drop-shadow(0 0 18px rgba(201,139,255,0.9)) brightness(1.18);
        cursor: pointer;
      }
      @keyframes nodeGlow {
        0%, 100% { filter: drop-shadow(0 0 8px rgba(122,162,255,0.4)); }
        50%      { filter: drop-shadow(0 0 14px rgba(201,139,255,0.6)); }
      }
      ...
      .mermaid-wrap .mermaid g.actor text { fill: var(--text) !important; font-family: var(--font-body) !important; font-weight: 500; }
      ...
      .mermaid-wrap .mermaid .edgeLabel p { color: var(--text-dim) !important; background: transparent !important; font-family: var(--font-body) !important; }
